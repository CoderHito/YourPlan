...
public class HttpUtil {
	...
	public static String sendHttpsRequest(String requestUrl,
			String requestMethod, String requestParam) {
	...
	public static Map<Object, Object> httpPost(String url,
		...
		return httpPost(url, requestParams, HTTP.UTF_8);
	}
	...
	public static String httpPost(String url, String requeststr, String charSet) {
		return httpPost(url, requeststr, charSet,
				"application/x-www-form-urlencoded");
	}

	public static Map<Object, Object> httpPost(String url,
			Map<Object, Object> requestParams, String charSet) {
		return httpPost(url, requestParams, charSet,
				"application/x-www-form-urlencoded");
	}
	 ...
	 * @throws
	 */
	public static String httpPost(String url, String msg, String charSet,
			String contentType) {
	...
	public static Map<Object, Object> httpPost(String url,
		...
		HttpURLConnection httpURLConnection = null;
		String rtstr = "";
		String requeststr = FastJsonUtils.MapToString(requestParams);
		try {
			URL realUrl = new URL(url);
			// 打开和URL之间的连接
			httpURLConnection = (HttpURLConnection) realUrl.openConnection();
...
//			requeststr = URLEncoder.encode(requeststr, "UTF-8");
			...
			rtstr = responseResult.toString();
			result = FastJsonUtils.stringToMap(rtstr);
			LOG.info("响应：" + rtstr);
		} catch (Exception e) {
			LOG.error("POST请求异常", e);
		} finally {
