...
<body>
	<div class="container">
		<div class="row1">
			<div class="logo">
				<a title="YourPlan" href="index.html">
					<h3>YourPlan</h3>
				</a>
			</div>
			<div class="log-reg">
			...
			<div class="display">
				<div class="center">
					<a href="#" class="holder"><img
						src="<%=request.getContextPath()%>/img/01.png" /></a> <br /> <strong
						class="">日程</strong>
					<p>任务提醒、番茄时钟让你更专注于你的工作</p>
				</div>
				<div class="center">
					<a href="#" class="holder"><img
						src="<%=request.getContextPath()%>/img/01.png" /></a> <br /> <strong>计划</strong>
					<p>工作计划、进度跟进让你的团队协作可视化</p>
				</div>
				<div class="center">
					<a href="#" class="holder"><img
						src="<%=request.getContextPath()%>/img/01.png" /></a> <br /> <strong>笔记</strong>
					<p>工作总结，笔记分享让回顾变得简单而方便</p>
				</div>
			</div>
		</div>

		<div class="login_dialog" title="登录">
			<div class="login_user">
				<img src="<%=request.getContextPath()%>/img/user.png" /> <input
					class="login_user_name" type="text" placeholder="用户名" />
			</div>
			<div class="login_psw">
				<img src="<%=request.getContextPath()%>/img/password.png" /> <input
					class="login_user_psw" type="password" placeholder="密码" />
			</div>
		...
		<div class="register_dialog" title="注册">
			<div class="reg_user">
				<img src="<%=request.getContextPath()%>/img/user.png" /> <input
			...
			<div class="reg_psw">
				<img src="<%=request.getContextPath()%>/img/password.png" /> <input
					class="reg_user_psw" type="password" placeholder="密码" />
			</div>

			<div class="reg_psw">
				<img src="<%=request.getContextPath()%>/img/password.png" /> <input
					class="reg_user_repsw" type="password" placeholder="重复密码" />
			</div>
